...
describe 'GET /mentors', type: :request do
  before :each do
    ...
    @u_1 = User.create(first_name: 'Travis', last_name: ' Gee', cohort: 1810, program: 'FE', current_job: 'google', background: 'IT', mentor: true, city: 'Denver', state: 'CO')
    ...
    @u_2 = User.create(first_name: 'Bob', last_name: ' Gee', cohort: 1810, program: 'FE', current_job: 'google', background: 'IT', mentor: true, city: 'New York', state: 'NY')
    ...
    @u_3 = User.create(first_name: 'Jordan', last_name: 'Gee', cohort: 1810, program: 'FE', current_job: 'google', background: 'IT', mentor: true, city: 'New York', state: 'NY')
    ...
    @u_4 = User.create(first_name: 'J', last_name: 'J', cohort: 1810, program: 'FE', current_job: 'google', background: 'IT', mentor: true, city: 'Denver', state: 'CO')
    ...
    @u_5 = User.create(first_name: 'JJ', last_name: 'JJJ', cohort: 1811, program: 'BE', current_job: 'google', background: 'IT', mentor: true, city: 'Raleigh', state: 'NC')
    ...
    context 'passing location:all as params' do
      it 'returns mentor users in and outside of denver who have any tech skill' do
        ...
        mentor_json.each do |json|
          ...
          expect(json["attributes"]).to have_key("city")
          expect(json["attributes"]).to have_key("state")
    ...
    context 'passing location:denver as params' do
      it 'returns mentor users in denver who have any tech skill' do
        get '/api/v1/mentors', params: { city: 'denver', state: 'co' }
        ...
        mentor_json.each do |json|
          expect(json["attributes"]["city"].downcase).to eq("denver")
          expect(json["attributes"]["state"].downcase).to eq("co")
          expect(json["attributes"]["mentor"]).to be_truthy
        end
      end
    end
    ...
    context 'passing location:remote, tech_skills=\'javascript\' as params' do
      it 'returns mentor outside of denver who have javascript as tech skill' do
        get '/api/v1/mentors', params: { city: '!denver', state: '!co', tech_skills: 'javascript' }
    ...
    context 'passing location:denver, tech_skills=\'javascript\' as params' do
      it 'returns mentor users in denver who have javascript as tech skill' do
        ...
        expect(mentor_json.first["attributes"]["mentor"]).to be_truthy
        expect(mentor_json.first["attributes"]["city"].downcase).to eq("denver")
        expect(mentor_json.first["attributes"]["state"].downcase).to eq("co")
        expect(mentor_json.first["attributes"]["tech_skills"]).to eq(["javascript"])
      end
    end
    context 'passing location:denver, tech_skills=\'ruby\' as params' do
      it 'returns mentor users in denver who have ruby as tech skill' do
        get '/api/v1/mentors', params: { city: 'denver', state: 'co', tech_skills: 'ruby' }
    ...
    context 'passing location:remote, tech_skills=\'ruby\' as params' do
      it 'returns mentor users not in denver who have ruby as tech skill' do
        ...
        expect(mentor_json.first["attributes"]["mentor"]).to be_truthy
        expect(mentor_json.first["attributes"]["city"].downcase).to eq("new york")
        expect(mentor_json.first["attributes"]["state"].downcase).to eq("ny")
        expect(mentor_json.first["attributes"]["tech_skills"]).to eq(["ruby"])
      end
    end
